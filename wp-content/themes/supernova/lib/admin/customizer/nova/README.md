...
[![Build Status](https://travis-ci.org/aristath/nova.svg?branch=master)](https://travis-ci.org/aristath/nova) [![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/aristath/nova/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/aristath/nova/?branch=master) [![Code Climate](https://codeclimate.com/github/aristath/nova/badges/gpa.svg)](https://codeclimate.com/github/aristath/nova) [![Coverage Status](https://coveralls.io/repos/aristath/nova/badge.svg?branch=master)](https://coveralls.io/r/aristath/nova?branch=master) [![License](https://img.shields.io/badge/license-GPL--2.0%2B-red.svg)](https://raw.githubusercontent.com/aristath/nova/master/LICENSE) [![Join the chat at https://gitter.im/aristath/nova](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/aristath/nova?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)

**Configurations**

Add your own Kirki configuration so that all the fields you create using Kirki inherit the configuration's properties.
More information on configurations can be found on our [Wiki](https://github.com/aristath/nova/wiki/Configuration).

**Add Panels**

Want to use Kirki to add your panels? Please look at the documentation on our [Wiki](https://github.com/aristath/nova/wiki/Panels)

**Add Sections**

Want to use Kirki to add your sections? Please look at the documentation on our [Wiki](https://github.com/aristath/nova/wiki/Sections)

**Add Fields**

Kirki allows you to create your fields easily and without any issues.
There are 3 syntaxes you can use to do that, depending on your preferences and the project at hand. More info about how to add fields can be found on the [Wiki](https://github.com/aristath/nova/wiki/Fields)
...
All you have to do is use the `output` argument inside your fields and everything else is taken care of. More information on that can be found on our [Wiki page for the output argument](https://github.com/aristath/nova/wiki/output)

**Automatic JS generation for postMessage**

If you want to use postMessage we've got you covered... Chances are you won't need to write your custom JS, we can auto-generate that for you if you use the `js_vars` argument in your fields. More info on that can be found on our [Wiki page for the js_vars argument](https://github.com/aristath/nova/wiki/js_vars)
...
Go ahead and take a look at [styling the customizer](https://github.com/aristath/nova/wiki/Styling-the-Customizer)

**Google Fonts Integration**

Kirki also integrates with Google Fonts, allowing you to use ALL google fonts and their variants in your themes. We take care of all the calculations for you, all you have to do is add your fields and let us handle the rest. Take a look at the [Google Fonts Integration](https://github.com/aristath/nova/wiki/Google-Fonts-Integration) page for an example and instructions.
...
For documentation and examples on how to use the plugin please visit the [Kirki Wiki on Github](https://github.com/aristath/nova/wiki).
...
All development is done on github on https://github.com/aristath/nova

If you wish to donate you can do so on http://nova.org
...
For configuration instructions please visit the [Kirki Wiki on Github](https://github.com/aristath/nova/wiki).

**Method 2: Embed in your theme**

Please visit https://github.com/aristath/nova/wiki/Embedding-in-a-theme for documentation and instructions.
...
* FIX: nova_get_option now uses Kirki::get_option().
...
* NEW: Added a new API. See https://github.com/aristath/nova/wiki for documentation.
...
* NEW: Added ability to get variables for CSS preprocessors from the customizer values. See https://github.com/aristath/nova/wiki/variables for documentation
...
* NEW: Implement width argument in the styling options. See https://github.com/aristath/nova/wiki/Styling-the-Customizer
* NEW: add 'nova/control_types' filter
...
* TWEAK: move the nova/fields & nova/controls filters to the new API
...
* NEW: added a functional nova_get_option() function
...
* REMOVED: Remove the `nova_get_option` function that was introduced in 0.7 as it's not working properly yet.
...
* NEW: Added `description` argument in the nova configuration (replaces the theme description)
...
* NEW: Added `nova_get_option( $setting );` function that also gets default values
