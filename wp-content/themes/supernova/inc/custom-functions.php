...
if( ! function_exists( 'sup_site_branding' ) )
{
	function sup_site_branding()
	{
		...
		if ( is_front_page() && is_home() ){ ?>
			<h1 class="site-title sup-site-title<?php echo $title_class; ?>"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php echo esc_html($site_title); ?></a></h1>
		<?php } else { ?>
			<span class="site-title sup-site-title<?php echo $title_class; ?>"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php echo esc_html($site_title); ?></a></span>
		<?php }

		?>

		<p class="site-description sup-site-description<?php echo $desc_class; ?>"><?php bloginfo( 'description' ); ?></p>
