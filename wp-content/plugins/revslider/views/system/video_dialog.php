	...
	<div class="video_left">
		...
		<div id="video_hidden_controls" style="display:none;">
			...
			<div class="mtop_20">
				...
				<label for="input_video_fullwidth" class="video-title float_left mleft_20">
					<?php _e("Loop Video:",REVSLIDER_TEXTDOMAIN)?>
				</label>
				
				<input type="checkbox" class="checkbox_video_dialog float_left" id="input_video_loop" ></input>
				
				<label for="input_video_fullwidth" class="video-title float_left mtop_10">
				...
				<div class="clear"></div>
				<span class="video_example"><?php _e("(best results with autoplay enabled)",REVSLIDER_TEXTDOMAIN)?></span>
			</div>
			<div class="clear"></div>
			<div class="video-title mtop_20" id="preview-image-video-wrap">
				<?php _e("Preview Image:",REVSLIDER_TEXTDOMAIN)?><br>
			...
			<div class="mtop_20">
				<label for="input_video_autoplay" class="video-title">
					<?php _e("Autplay:",REVSLIDER_TEXTDOMAIN)?>
				</label>
				<input type="checkbox" class="checkbox_video_dialog" id="input_video_autoplay" ></input>
				<br>
				
				<label for="input_video_autoplay_first_time" class="video-title">
					<?php _e("Autplay Only First Time:",REVSLIDER_TEXTDOMAIN)?>
				</label>
				<input type="checkbox" class="checkbox_video_dialog" id="input_video_autoplay_first_time" ></input>
				<br>
				
				<label for="input_video_nextslide" class="video-title">
					<?php _e("Next Slide On End:",REVSLIDER_TEXTDOMAIN)?>
				</label>
				<input type="checkbox" class="checkbox_video_dialog" id="input_video_nextslide" ></input>
